...
class Rsa2048Pkcs15EncryptionRoute extends StatefulWidget {
  const Rsa2048Pkcs15EncryptionRoute({Key? key}) : super(key: key);

  final String title = 'PKCS 1.5 Verschlüsselung';
...
class _MyFormPageState extends State<Rsa2048Pkcs15EncryptionRoute> {
  @override
  void initState() {
    super.initState();
  ...
  String txtDescription =
      'RSA 2048 Verschlüsselung mit PKCS 1.5 Padding (maximal 214 Zeichen).'
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                TextFormField(
                  ...
                  autocorrect: false,
                  decoration: InputDecoration(
                    labelText: 'Klartext (maximal 245 Zeichen)',
                    border: OutlineInputBorder(),
                  ),
                  validator: (value) {
                        ...
                        onPressed: () {
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            try {
                              ...
                              ciphertextBase64 =
                                  publicKey.encryptPkcs1v15ToBase64(plaintext);
                            } catch (error) {
                            ...
                            // build output string
                            String _formdata =
                                'RSA-2048 PKCS 1.5' + ':' + ciphertextBase64;
