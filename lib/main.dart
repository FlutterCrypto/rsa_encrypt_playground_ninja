...
class _MainFormPageState extends State<MainFormPage> {
  ...
  Widget linkWidget() {
    return Container(
      ...
      child: Text(
        'Beschreibung des Programms: http://fluttercrypto.bplaced.net/flutter-rsa-encryption-playground-ninja',
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Link(
                  ...
                  uri: Uri.parse('http://fluttercrypto.bplaced.net/flutter-rsa-encryption-playground-ninja/'),
