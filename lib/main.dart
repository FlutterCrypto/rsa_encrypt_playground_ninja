...
class _MainFormPageState extends State<MainFormPage> {
  ...
  Widget linkWidget() {
    return Container(
      ...
      child: Text(
        'Beschreibung des Programms: http://fluttercrypto.bplaced.net/rsa-encrypt-playground-ninja/',
        //'Program description: http://fluttercrypto.bplaced.net/rsa-encrypt-playground-ninja/',
        style: TextStyle(
          fontSize: 18,
          color: Colors.blue,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Link(
                  ...
                  uri: Uri.parse('http://fluttercrypto.bplaced.net/rsa-encrypt-playground-ninja/'),
